(function() {
    ...
    window.loginView = kendo.observable({
        submit: function(){
            ...
            el.Users.login(this.username, this.password, function(data){
                ...
                navigator.notification.alert("You don't have an account.");
            });
        }
    });
    ...
    window.listView = kendo.observable({
        logout: function(event){
            ...
            el.Users.logoutfunction(function(){
                this.loginView.set("username", "");
                this.loginView.set("password", "");
                window.location.href = "#login";
            },function(){
                navigator.notification.alert("Error while logging out");
            });
        }
    });
    window.addView = kendo.observable({
        add: function(){
            if (!this.grocery){
                navigator.notification.alert("Please provide a grocery, dummy.");
                return;
            }
